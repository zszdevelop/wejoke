...
this.requestNet();
   ...
   requestNet: function () {
    ...
    let _artArray =[];
    wx.request({
      url: 'https://route.showapi.com/341-2?showapi_sign=ef07e49819e24259a37cebf35a208135&showapi_appid=27240&page='+page++,
      data: {
        // showapi_appid: '27240',
      ...
      success: function (res) {
        ...
        contentlists.map(function (num) {
          return _artArray.push({message:num.title,content:num.text,src:num.img});
        }
        );
        that.setData({
          array:_artArray
